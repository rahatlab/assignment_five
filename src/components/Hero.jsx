        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <button className="btn gradient-brand text-white px-6 py-5 rounded-lg font-sm lg:font-medium hover:opacity-90 transition">
                Explore Technologies
              </button>
              <button className="btn border border-gray-300 text-gray-700 px-8 py-5 rounded-lg font-sm lg:font-medium hover:bg-gray-50 transition">
                Learn More
              </button>
            </div>
          </div>
